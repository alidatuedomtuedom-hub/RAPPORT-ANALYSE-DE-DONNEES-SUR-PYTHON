...
iles = ouvrirUnFichier("./src/data/island-index.csv")
#print(iles.head())
...
#Question 7 : On ne peut pas faire des tests sur des rangs
...
monde = ouvrirUnFichier("./src/data/Le-Monde-HS-Etats-du-monde-2007-2025.csv")
#print(monde.head())
...
#Ce script fonctionne, mais il repose sur beaucoup de boucles et de conversions “à la main”.
#Même si ça aide à comprendre la logique du tri et du classement, ça rend le code plus long et plus répétitif.
#Avec Pandas, on pourrait obtenir les mêmes classements (tri, rangs, comparaisons) en quelques lignes seulement,
#ce qui améliorerait la lisibilité, limiterait les erreurs, et rendrait le travail plus facile à reproduire.
...
#Question 14: coeficient de corrélation et concordance des rangs 
